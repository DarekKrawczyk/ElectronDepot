namespace ElectroDepotClassLibrary.Endpoints
{
    public static class ComponentEndpoints
    {
        ...
        public static string GetByID(int ID) => $"ElectronDepot/Components/GetCategoryByID/{ID}";
        public static string GetByName(string Name) => $"ElectronDepot/Components/GetCategoryByName/{Name}";
