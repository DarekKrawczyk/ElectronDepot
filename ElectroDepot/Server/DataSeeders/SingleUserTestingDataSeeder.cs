    ...
    public static async Task SeedDataAsync(DatabaseContext context)
    {
        ...
        if (!context.Users.Any())
        {
            ...
            List<OwnsComponent> ownsComponents = new List<OwnsComponent>
            {
                ...
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[80].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[50].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[41].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[21].ComponentID, Quantity = 1 },
                ...
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[21].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[4].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[3].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[75].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[47].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[13].ComponentID, Quantity = 2 },
                ...
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[79].ComponentID, Quantity = 2 },
                ...
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[3].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[83].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[59].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[46].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[24].ComponentID, Quantity = 2 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[81].ComponentID, Quantity = 2 },
                ...
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[56].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[75].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[23].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[64].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[70].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[71].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[80].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[80].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[56].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[36].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[67].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[81].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[47].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[78].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[45].ComponentID, Quantity = 1 },
                new OwnsComponent { UserID = users[0].UserID, ComponentID = components[46].ComponentID, Quantity = 1 }
            };
